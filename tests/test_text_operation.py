...
from models.content_operation import ContentOperation as TextOperation, DeleteOperation, InsertOperation, ReplaceOperation


class TestTextOperationValidation:
    """Test TextOperation model validation."""

    async def test_insert_valid(self):
    ...
    async def test_insert_position_zero_valid(self):
    ...
    async def test_text_empty_string_fails(self):
